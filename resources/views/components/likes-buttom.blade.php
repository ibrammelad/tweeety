<div class="flex">
    ...
    <form method="post" action="/tweets/{{$tweet->id}}/like">
        ...
        <div  class="flex items-center mr-4">
            ...
            <button type="submit" class="text-xs">
                <svg viewBox="0 0 20 20" class="text-gray-500 w-5 mr-1  {{$tweet->isLikedBy(Current_user()) ? 'text-blue-500' : 'text-gray-500'}}">
    ...
    <form method="post" action="/tweets/{{$tweet->id}}/like">
        ...
        <div class="flex items-center ">
            ...
            <button type="submit" class="text-xs">
                <svg viewBox="0 0 20 20" class=" w-5 mr-1 {{$tweet->isDislikedBy(Current_user()) ? 'text-blue-500' : 'text-gray-500'}} " >
                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g class="fill-current">
